...
SAMPLE_KEY_ANNOTATION = """
    # Set environment variables "AZURE_KEY" with real value which can access your service 
"""

SAMPLE_CLIENT_SUB = """
    # Please set environment variables "AZURE_SUBSCRIPTION_ID" with real value
"""
